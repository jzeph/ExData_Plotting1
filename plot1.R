#plot1.R script for Course Project 1 in Exploratory Data Analysis class
...
#Create plot 1, a histogram of Global Active Power (household global minute-averaged active power, in kilowatt) for these dates
hist(power$Global_active_power, col = "red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)", ylim = c(0, 1200))
